How to contribute to Cozy Konnector Numericable?
================================================
...
- What is the version of the Cozy Konnector Numericable?
...
```
$ git clone github.com/cozy/cozy-konnector-numericable.git
$ cd cozy-konnector-numericable
$ git remote add fork git://github.com/yourusername/cozy-konnector-numericable.git
```
...
Go to https://github.com/yourusername/cozy-konnector-numericable and select your branch. Click the 'Pull Request' button and fill out the form.
...
The Cozy Konnector Numericable is translated on a platform called [Transifex][tx]. [This tutorial][tx-start] can help you to learn how to make your first steps here. If you have any question, don't hesitate to ask us!
...
[issues]: https://github.com/cozy/cozy-konnector-numericable/issues/new
...
[localization]: https://github.com/cozy/cozy-konnector-numericable/blob/master/README.md#localization
