[Cozy][cozy] Konnector Numericable
==================================
...
Download all your Numéricable Bills.
...
git://github.com/cozy/cozy-konnector-numericable.git#build
...
this konnector was created and maintained by @nicofrand.
...
Cozy Konnector Numericable is developed by Cozy and distributed under the [AGPL v3 license][agpl-3.0].
